...
____
## Запуск проекта
Для запуска проекта необходимы сервер с поддержкой языка PHP и база данных.
...
База данных на сервере включает в себя 4 таблицы: категории (регионы), публикации, комментарии и пользователи.

![Схема базы данных](https://github.com/trolleyfun/BlogWebSite/blob/main/db/db_scheme.png)
#### Категории (регионы)
