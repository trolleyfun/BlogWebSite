...
Ссылка на сайт: [https://blogwebsite.h1n.ru/](https://blogwebsite.h1n.ru/)
____
## Цели проекта
...
3. Укажите e-mail сервера и e-mail для получения обращений от пользователей в файле "admin/includes/admin_functions.php";
4. Для авторизации на сайте можете использовать следующие параметры:
    + логин: admin
    + пароль: adminadmin
____
## Описание
...
+ **"Поддержка"** &ndash; форма для обращений;
...
#### Раздел "Поддержка"
На странице раздела размещена форма для обращений, состоящая из следующих полей: "Тема обращения", "E-mail для ответа", "Текст обращения". Обращения приходят на почтовый ящик администрации сайта.
