...
<div class="well">
    ...
    <form role="form" action="" method="post">
        <div class="form-group">
            ...
            <span style='color: #a94442;'><?php displayErrorMessage($err_add_comment['comment_author'], "Введите имя пользователя"); ?></span>
        </div>
        <div class="form-group">
            <label for="comment_email">E-mail:</label>
            <input type="email" name="comment_email" id="comment_email" class="form-control">
            <span style='color: #a94442;'><?php displayErrorMessage($err_add_comment['comment_email'], "Введите e-mail"); ?></span>
        </div>
        <div class="form-group">
            ...
            <span style='color: #a94442;'><?php displayErrorMessage($err_add_comment['comment_content'], "Введите текст комментария"); ?></span>
        </div>
